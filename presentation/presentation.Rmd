...
$$\Large{N(t) = N_0 ~ \underbrace{\exp(u)}_{\substack{\text{rate of} \\ \text{change}}} \underbrace{\exp(w t)}_{\substack{\text{stochastic} \\ \text{environment}}}}$$
...
$$\Large{\log (N_t) = \log (N_{t-1}) + u + w_t}$$
...
> ## .blue[ Northwest Power and Conservation Council responsible for supporting conservation and
determining whether actions are cost-effective ]
...
> # Solution?<br><br>Spend some money on restoration activities
...
> ## .blue[Applied smolt-to-adult survival to hatchery releases]

> ## .blue[Calculated expected adult returns]
