---
title: "Large-scale status assessments of at-risk species and efforts to recovery them"
subtitle: "Mark D. Scheuerell"  
# subtitle: "Upper Columbia Salmon Conference<br>Wenatchee, WA<br>25 Januray 2024"  
author: 
#  - "Mark Scheuerell"
  - "_U.S. Geological Survey<br>Washington Cooperative Fish and Wildlife Research Unit<br>School of Aquatic and Fishery Sciences<br>University of Washington_"
# date: '`r Sys.Date()`'
output:
...
> ## .blue[ Bull trout in the Pacific Northwest ]

> ## .green[ Restoration spending in the Columbia basin ]
...
> ### .green[population trends].lightgray[, distribution, demographics & genetics]

> ### .lightgray[habitat conditions]

> ### .lightgray[past conservation measures]

> ### .lightgray[status & trends of threats]
...
# Restoration spending<br>in the Columbia River basin
...
# .blue.center[Bill Jaeger<br>_Department of Applied Economics_<br>_Oregon State Univeristy_]


---

class: frimg, inverse-black, center
background-image: url(figs/columbia_map.png)
background-position: 50% 50%
background-size: 63%
...
> ## .blue[ Problems acknowledged in the 1938 Mitchell Act ]
...
> ## .blue[ Actions involve 11 federal agencies ]

> ## .blue[ 1980 Northwest Power Act obligates BPA to provide equitable treatment to fish and wildlife]

> ## .blue[ Northwest Power & Conservation Council responsible for determining whether actions are cost-effective ]


---

class: frimg, center
background-image: url(figs/annual_spending.png)
background-position: 40% 80%
background-size: 70%

# Annual spending

#### .citation.gray[US Fish Wildlife Service]


---

class: frimg, center
background-image: url(figs/cum_spending.png)
background-position: 40% 80%
background-size: 70%
...
> ## .blue[ 15,000+ restoration projects undertaken<br>at an annual cost of over $150 million]

### .citation.gray[Katz & Barnas (2010) _Fisheries_]


---

class: frimg, inverse-black
background-image: url(figs/mcnary_dam.jpg)
background-position: 50% 50%
background-size: 85%
...
class: frimg, center
background-image: url(figs/releases.png)
background-position: 40% 80%
background-size: 70%

# Hatchery releases

#### .citation.gray[Regional Mark Processing Center]
...
> # And what has this done for salmon?


---

class: frimg, center
background-image: url(figs/adult_returns.png)
background-position: 40% 80%
background-size: 70%

# Adult returns to Bonneville

#### .citation.gray[Fish Passage Center]


---

# More formally (in log space)

<br>

## .center[Returns = .purple[Spawners] + .blue[Ocean] + .aqua[River] + .orange[Releases] + .green[Spending]]
...
## Predictors lagged to match life history
...
> ## .blue[A 1% increase in spending in a year corresponds to a<br>0.075% increase in returns]


---

class: frimg, center
background-image: url(figs/model_fits_h.png)
background-position: 40% 80%
background-size: 70%
...
> ## .blue[Spending & hatchery releases are confounded]

> ## .blue[Solution was to use a counterfactual]
...
> ## .blue[Model gives us the expected total adult returns]

$$\huge{\hat{T} = \hat{H} + \hat{W}}$$
...
> ## .blue[Applying smolt-to-adult survival estimates to hatchery releases gives us estimated hatchery returns]

$$\huge{\hat{H} = \widehat{SAR} \times Releases}$$


---

# Test of spending effect

> ## .blue[Null hypothesis:]

$$\huge{\hat{T} - \hat{H} \leq 0}$$ 
...
> ## .blue[We cannot reject this and conclude that]

> ## .red[No impact of conservation spending on wild salmon and steelhead]
...
.pull-left.center[<img src="figs/QR_bulltrout.png" width=300 height=300>]

.pull-right.center[<img src="figs/QR_columbia.png" width=300 height=300>]

### .pull-left.center.blue[Bull trout]

### .pull-right.center.green[Columbia spending]

### .citation.purple[`r icon_style(fontawesome("envelope"), fill = "#844870")` scheuerl@uw.edu]
